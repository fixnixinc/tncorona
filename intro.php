        ...
        <div class="col-xs-6 col-md-2">
            ...
            <div class="panel status" style="background-color: #FCD7D7;">
                ...
                <div class="panel-body text-center" style="background-color: #FEF5F5;">        
                    ...
                    <strong style="color: #E53E3E; font-size: 24px;" id="conf">3,83,390</strong>
                </div>
            </div>
        ...
        <div class="col-xs-6 col-md-2">
            ...
            <div class="panel status" style="background-color: #C6F6D5; ">
                ...
                <div class="panel-body text-center" style="background-color: #F0FFF4;">  
                    ...
                    <strong style="color: #38A169; font-size: 24px;" id="death">16,582</strong>
                </div>
            </div>
...
<script type="text/javascript">
  function fun ()
  {
     ...
     if(sa=="China")
        {
      document.getElementById("conf").innerHTML="81,171";
      document.getElementById("death").innerHTML="3,277";
      document.getElementById("case").innerHTML="431";
      document.getElementById("info").innerHTML="457";
       }
    if(sa=="italy")
    {
        document.getElementById("conf").innerHTML="63,927";
       document.getElementById("death").innerHTML="6,077";
       document.getElementById("case").innerHTML="66";
       document.getElementById("info").innerHTML="70";
    }
      if(sa=="iran")
    {
        document.getElementById("conf").innerHTML="23,049";
       document.getElementById("death").innerHTML="1,812";
       document.getElementById("case").innerHTML="54";
       document.getElementById("info").innerHTML="57";
    }
     if(sa=="Korea")
    {
      document.getElementById("conf").innerHTML="9,037";
      document.getElementById("death").innerHTML="120";
      document.getElementById("case").innerHTML="42";
      document.getElementById("info").innerHTML="44";
    }
     if(sa=="Spain")
    {
        document.getElementById("conf").innerHTML="35,212";
       document.getElementById("death").innerHTML="2,316";
       document.getElementById("case").innerHTML="12";
       document.getElementById("info").innerHTML="13";
    }
     if(sa=="France")
    {
        document.getElementById("conf").innerHTML="19,856";
       document.getElementById("death").innerHTML="860";
       document.getElementById("case").innerHTML="12";
       document.getElementById("info").innerHTML="13";
    }
     if(sa=="Germany")
    {
        document.getElementById("conf").innerHTML="29,056";
       document.getElementById("death").innerHTML="123";
       document.getElementById("case").innerHTML="12";
       document.getElementById("info").innerHTML="13";
    }
     if(sa=="States")
    {
        document.getElementById("conf").innerHTML="26,863";
      ...
      if(sa=="Japan")
    {
        document.getElementById("conf").innerHTML="1,140";
       document.getElementById("death").innerHTML="42";
       document.getElementById("case").innerHTML="4";
       document.getElementById("info").innerHTML="4";
    }
     if(sa=="Switzerland")
    {
        document.getElementById("conf").innerHTML="8,795";
       document.getElementById("death").innerHTML="120";
       document.getElementById("case").innerHTML="4";
       document.getElementById("info").innerHTML="4";
    }
     if(sa=="Kingdom")
    {
        document.getElementById("conf").innerHTML="5,018";
     ...
     if(sa=="Netherlands")
    {
        document.getElementById("conf").innerHTML="4,749";
       document.getElementById("death").innerHTML="213";
       document.getElementById("case").innerHTML="3";
       document.getElementById("info").innerHTML="3";
    }
     if(sa=="Belgium")
    {
        document.getElementById("conf").innerHTML="3,743";
       document.getElementById("death").innerHTML="88";
       document.getElementById("case").innerHTML="2";
       document.getElementById("info").innerHTML="2";
    }
     if(sa=="Sweden")
    {
        document.getElementById("conf").innerHTML="2,059";
     ...
     if(sa=="Norway")
    {
        document.getElementById("conf").innerHTML="2,625";
      ...
      if(sa=="Singapore")
    {
        document.getElementById("conf").innerHTML="509";
     ...
     if(sa=="Austria")
    {
        document.getElementById("conf").innerHTML="4,578";
     ...
     if(sa=="Malaysia")
    {
        document.getElementById("conf").innerHTML="1,518";
     ...
     if(sa=="Hong Kong")
    {
        document.getElementById("conf").innerHTML="357";
     ...
     if(sa=="Denmark")
    {
        document.getElementById("conf").innerHTML="1,460";
     ...
     if(sa=="Bahrain")
    {
        document.getElementById("conf").innerHTML="377";
       document.getElementById("death").innerHTML="2";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="1";
    }
     if(sa=="Australia")
    {
        document.getElementById("conf").innerHTML="2,136";
      ...
      if(sa=="Greece")
    {
        document.getElementById("conf").innerHTML="695";
     ...
     if(sa=="Canada")
    {
        document.getElementById("conf").innerHTML="2,091";
       document.getElementById("death").innerHTML="24";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="1";
    }
     if(sa=="Arab")
    {
     ...
     if(sa=="Iraq")
    {
        document.getElementById("conf").innerHTML="266";
     ...
     if(sa=="Kuwait")
    {
     ...
     if(sa=="Iceland")
    {
        document.getElementById("conf").innerHTML="588";
     ...
     if(sa=="Egypt")
    {
        document.getElementById("conf").innerHTML="366";
      ...
      if(sa=="India")
    {
        document.getElementById("conf").innerHTML="511";
     ...
     if(sa=="Thailand")
    {
        document.getElementById("conf").innerHTML="827";
       document.getElementById("death").innerHTML="4";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="San Marino")
    {
        document.getElementById("conf").innerHTML="187";
     ...
     if(sa=="Israel")
    {
        document.getElementById("conf").innerHTML="1,656";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="1";
    }
     if(sa=="Taiwan")
    {
        document.getElementById("conf").innerHTML="215";
       document.getElementById("death").innerHTML="2";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Lebanon")
    {
     ...
     if(sa=="Finland")
    {
        document.getElementById("conf").innerHTML="700";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
    ...
    {
        document.getElementById("conf").innerHTML="1,236";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="1";
    }
     if(sa=="Portugal")
    {
        document.getElementById("conf").innerHTML="2,060";
       document.getElementById("death").innerHTML="23";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="1";
    }
     if(sa=="Philippines")
    {
        document.getElementById("conf").innerHTML="501";
       document.getElementById("death").innerHTML="33";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     ...
     if(sa=="Brazil")
    {
        document.getElementById("conf").innerHTML="1,924";
     ...
     if(sa=="Slovenia")
    {
     ...
     if(sa=="Ireland")
    {
        document.getElementById("conf").innerHTML="1,125";
      ...
      if(sa=="Russia")
    {
        document.getElementById("conf").innerHTML="438";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="0";
    }
     ...
     if(sa=="Algeria")
    {
     ...
     if(sa=="Indonesia")
    {
        document.getElementById("conf").innerHTML="686";
       document.getElementById("death").innerHTML="55";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Oman")
     ...
     if(sa=="Qatar")
    {
     ...
     if(sa=="Romania")
    {
        document.getElementById("conf").innerHTML="576";
       document.getElementById("death").innerHTML="8";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
      ...
      if(sa=="Argentina")
    {
        document.getElementById("conf").innerHTML="301";
       document.getElementById("death").innerHTML="4";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="1";
    }
     if(sa=="Poland")
    {
        document.getElementById("conf").innerHTML="766";
       document.getElementById("death").innerHTML="8";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Pakistan")
    {
     ...
     if(sa=="Ecuador")
    {
        document.getElementById("conf").innerHTML="981";
     ...
     if(sa=="Georgia")
    {
     ...
     if(sa=="Croatia")
    {
        document.getElementById("conf").innerHTML="361";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Chile")
    {
        document.getElementById("conf").innerHTML="746";
       document.getElementById("death").innerHTML="2";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="0";
    }
      if(sa=="Estonia")
    {
        document.getElementById("conf").innerHTML="369";
       document.getElementById("death").innerHTML="0";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     ...
     if(sa=="Peru")
    {
        document.getElementById("conf").innerHTML="395";
     ...
     if(sa=="Azerbaijan")
    {
        document.getElementById("conf").innerHTML="71";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
      ...
      if(sa=="Mexico")
    {
     ...
     if(sa=="South Africa")
    {
        document.getElementById("conf").innerHTML="554";
       document.getElementById("death").innerHTML="0";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Slovakia")
    {
     ...
     if(sa=="Belarus")
    {
        document.getElementById("conf").innerHTML="81";
       document.getElementById("death").innerHTML="0";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="1";
    }1
     if(sa=="Albania")
    {
        document.getElementById("conf").innerHTML="104";
       document.getElementById("death").innerHTML="4";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Maldives")
    {
     ...
     if(sa=="Tunisia")
    {
        document.getElementById("conf").innerHTML="89";
      ...
      if(sa=="Luxembourg")
    {
        document.getElementById("conf").innerHTML="895";
       document.getElementById("death").innerHTML="8";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="1";
    }
     if(sa=="French Guiana")
    {
        document.getElementById("conf").innerHTML="23";
       document.getElementById("death").innerHTML="0";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="New Zealand")
    {
        document.getElementById("conf").innerHTML="155";
       document.getElementById("death").innerHTML="0";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
    ...
    {
        document.getElementById("conf").innerHTML="137";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="1";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Afghanistan")
    {
        document.getElementById("conf").innerHTML="42";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Senegal")
    {
        document.getElementById("conf").innerHTML="79";
       document.getElementById("death").innerHTML="0";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
      ...
      if(sa=="Bulgaria")
    {
        document.getElementById("conf").innerHTML="202";
       document.getElementById("death").innerHTML="3";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Serbia")
    {
        document.getElementById("conf").innerHTML="249";
       document.getElementById("death").innerHTML="3";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     ...
     if(sa=="Colombia")
    {
     ...
     if(sa=="Cyprus")
    {
        document.getElementById("conf").innerHTML="116";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Faroe Islands")
    {
      ...
      if(sa=="Morocco")
    {
        document.getElementById("conf").innerHTML="143";
       document.getElementById("death").innerHTML="4";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
     if(sa=="Nigeria")
    {
        document.getElementById("conf").innerHTML="40";
       document.getElementById("death").innerHTML="1";
       document.getElementById("case").innerHTML="0";
       document.getElementById("info").innerHTML="0";
    }
    if(sa=="gb")
    {
        document.getElementById("conf").innerHTML="3,83,390";
       document.getElementById("death").innerHTML="16,582";
