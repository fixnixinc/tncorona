...
@media only screen and (min-width: 320px) and (max-width: 768px) {
  ...
  <body> 
      ...
      <a class="navbar-brand" href="https://tncorona/speak.com/">
        <img src="modified_logo.png" width="45" height="45" class="d-inline-block align-top" alt="">
        <label style="padding-top:8px; font-size: 18px;"><strong>TamilNadu CoronaSpeak</strong></label>
      </a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown" style="margin-left: -22%;">
         <ul class="navbar-nav mx-auto order-0">

          <li class="nav-item" id="top_links_head">
            <a class="nav-link" href="speak.php">Speak<span class="sr-only">(current)</span></a>
          </li>&nbsp;&nbsp;&nbsp;&nbsp;

          <li class="nav-item" id="top_links_head">
            <a class="nav-link" href="https://telegra.ph/TN-Corona-Speak-03-27">Chat</a>
          </li>&nbsp;&nbsp;&nbsp;&nbsp;

          <li class="nav-item" id="top_links_head">
            <a class="nav-link" href="../tamilnadu/infection_db/index.html">Corona Infection Database </a>
          </li> 
...
function googleTranslateElementInit() {
  ...
  document.querySelector('.goog-te-gadget').setAttribute('style', 'font-size: 0');
    ...
    <div style="padding: 1%;">
      <a onclick="window.location.href='../login.php'"><img src="admin.webp" title="Admin" style="height: 64px;" /></a>
      <a onclick="window.location.href='../caselogin.php'"><img src="track.png" title="Track" style="float: right;height: 64px; " /></a>
    </div>
  ...
  $("#district").msDropdown();
          ...
          <div class="jumbotron jumbotron-fluid bg-light ">
           <div class="container" style="margin-left: 40%;">
             ...
             <a href="https:///tncorona/speak.com/tncorona/tamilnadu/infection_db/index.html" id="bottom_links_foot" style="color: #231F1F; font-size: 14px; margin-right: 18px; float: left;">CORONA INFECTION DATABASE</a>
