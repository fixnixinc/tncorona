...
?>
  <body> <br><br>
    <div class="container">
   <div>
           <button type="button" class="btn btn-outline-secondary btn-sm" style="border-radius:24px;float: left;width: 150px;height: 50px;font-size: 16px;" onclick="window.location.href='https://tncoronaspeak.com/corona/login.php'">Admin</button>
           <button type="button" class="btn btn-outline-secondary btn-sm" style="border-radius:24px;width: 150px;height: 50px;font-size: 16px; float: right;" onclick="window.location.href='https://tncoronaspeak.com/corona/caselogin.php'">Track</button>
        </div>
        <br>
        <br>
