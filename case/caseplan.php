  ...
  $("#district").msDropdown();
          ...
          <div class="jumbotron  bg-light">
            <div class="container" style="margin-left: 230px;">
             <a href="https://tncoronaspeak.com/corona/case/caseplan.php?=Infection" id="bottom_links_foot" style="color: #231F1F; font-size: 14px; margin-right: 18px; float: left;">SPEAK</a>
