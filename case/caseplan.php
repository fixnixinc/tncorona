...
$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
   if(isset($_POST['submit']))
   {
    ...
    $sql="INSERT INTO `case`(category,countries,Description,name,email,phone,ran,secretkey,Artifacts,status)
...
?>
 ...
 <h3 style="text-align: center;color: black;font-size: 32px;"> Case</h3><br>
...
<div class="container">
            ...
            <div class="form-group row" style="color: black;" >
              <div class="col-md-2">
            <label for="example-text-input" style="font-size: 20px;">Category :</label>
          </div>
          <div class="col-md-10" style="padding-left: 18%;">
        <div class="grid-two imageandtext" >

  <div class="imageandtext image_grid">
    <label for="selimg1" style="text-align: center;">Infection<br><br>
      <img src="./assets/media/company-logos/infection.jpg" class="img-thumbnail" style="height: 100px;width: 100px;border-radius: 50%;">
    </label>
    <input type="radio" name="selimg" id="selimg1" value="infection">
    <div class="caption">
  ...
  <div class="imageandtext image_grid">
    <label for="selimg2" style="text-align: center;">Possible Infection<br><br>
      <img src="./assets/media/company-logos/possibleinfection.png" class="img-thumbnail" style="height: 100px;width: 100px;border-radius: 50%;">
    </label>
    <input type="radio" name="selimg" id="selimg2" value="Possibleinfection">
    <div class="caption">
...
<div class="form-group row" id="category">
    ...
    <div class="form-group row" id="div0" name="Description" style="display: none;">
      <div class="col-md-2">
            <label for="example-text-input" style="color: black;font-size: 20px;">Country :</label>
          </div>
            <div class="col-md-10">
                <div id="searchbox2">
