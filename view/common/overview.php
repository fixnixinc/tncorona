                    ...
                    <div class="kt-widget__section">
                        ...
                        <div>                            
                          ...
                          <div>
                            ...
                            <i>CoronaSpeak@nixwhistle.com</i>                            
                        </div>
                    </div>
                </div>
            </div>
...
<div class="kt-portlet kt-portlet--head--noborder kt-portlet--height-fluid">
  ...
  $que="SELECT * from info order by id desc ";
...
<div>
  <button class="btn btn-success" style="float: right;"><a href="view/common/addadminuser.php" style="color:white;">Adduser</a></button>
   <button class="btn btn-danger" style=""><a href="view/common/bulkbusinessunit.php" style="color:white;">Add Country</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tbody>
                      <?php
  $link=mysqli_connect("localhost","root","CoronaSpeak1234#@","corona");
  $que="SELECT * from country order by id desc ";
  $res=mysqli_query($link,$que);
  while ($row=mysqli_fetch_assoc($res)) {
  ?>
            ...
            <td><?php echo $row['id'];?></td>
                    ...
                    <td><?php echo $row['ministry'];?></td>
                      ...
                      <td><button class="btn btn-primary"><a href="/tncorona/view/common/editbulkbussinessunit.php?userId=<?php echo $row['id']; ?>" style="color: white;">Edit</a></button></td>
                   </tr>
