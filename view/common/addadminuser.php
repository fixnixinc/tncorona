...
<?php foreach ($allUsersArray as $data) { ?>
                    ...
                    <td><?php echo $data['company_id']; ?></td>
                       ...
                       <td><button class="btn btn-primary"><a href="/corona/view/common/edituserprofile.php?userId=<?php echo $data['id']; ?>" style="color: white;">Edit</a></button></td>
