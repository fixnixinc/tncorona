            ...
            if($rows=mysqli_fetch_assoc($result))
             {    
              $password == 'CoronaSpeak';
               ...
               if($rows['email']=='CoronaSpeak@nixwhistle.com'&& $rows['password'] == 'CoronaSpeak')
               {
               
                 // echo "Sucessfully";
                header("location:/corona/view/common/overview.php");
               // break;
               }
             }
