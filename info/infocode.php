...
<script type="text/javascript">
  ...
  type:'success'
      ...
      window.location="/corona/intro.php";
  });
  }
</script>
<?php
 ...
 <a href="https://instagram.com/CoronaSpeak"><i class="fa fa-instagram" style="font-size:32px"></i></a>
       ...
       <nav class="navbar navbar-light bg-light">
           <div class="mx-auto order-0">
             <label style="font-size: 12px;">An Open Initiative of <span><a href="https://www.nixwhistle.com"><strong>NixWhistle</strong>  </a>and<span><a href="https://tncoronaspeak.com/corona/contributors.php" id="bottom_links_foot" style=" font-size: 12px;"> Volunteers</a></span></span> </label>  <br>      
            </div>
         </nav>
<script type="text/javascript">
