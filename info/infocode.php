...
$sql = "SELECT secretkey,ran,countries from info order by id DESC limit 1";
$result = mysqli_query($link, $sql);
...
<!--                 <div class="" style="text-align: center;font-size: 20px;"><strong>WhistleBlower - Remember this is for future use</strong></div> -->
              <div class="modal-body" style="text-align:center;">
               <div class="form-group">
                <h2 style="color: red">We will update you the progress at the earliest.
In case of urgency, <br>please contact your <br>District Control Room Number- 04151-220000</h2>
